...
| T2 | [`SPEC_T2_cluster_admin_tier.md`](SPEC_T2_cluster_admin_tier.md) — the cluster-admin tier: `visibility.clusterAdminSar` (`update clusterrolebindings` on the host) gates the KPI page and the whole Cluster Configurations tab, and grants every host tier to whoever passes it; replaces #230's two-level pair | T — tiers | — | app 0.35.0, chart 0.57.0 | [#322](https://github.com/ephico2real2/group-sync-dashboard/issues/322) | in progress |
