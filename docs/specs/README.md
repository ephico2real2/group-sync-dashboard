...
| E1 | [`SPEC_E1_report_library.md`](SPEC_E1_report_library.md) — the report library tab: one section per configured report, a run's expiry from the service | E — after the programme | — | app 0.25.0 | [#229](https://github.com/ephico2real2/group-sync-dashboard/issues/229) | in progress |
| S1 | [`SPEC_S1_cluster_secrets.md`](SPEC_S1_cluster_secrets.md) — clusters as labelled Secrets: the contract, the reader, the API | S — cluster configuration | — | chart 0.42.0, migration 19 | [#230](https://github.com/ephico2real2/group-sync-dashboard/issues/230) | in implementation |
| S2 | [`SPEC_S2_cluster_configurations_tab.md`](SPEC_S2_cluster_configurations_tab.md) — the Cluster Configurations tab: the writes, the form and its GitOps twin | S — cluster configuration | — | chart 0.44.0 | [#230](https://github.com/ephico2real2/group-sync-dashboard/issues/230) | in implementation |
| S3 | [`SPEC_S3_connection_modes.md`](SPEC_S3_connection_modes.md) — connection modes: the dashboard obtains a remote cluster's credential (SATokenLookup, userSelfLogin) | S — cluster configuration | — | chart 0.45.0 | [#230](https://github.com/ephico2real2/group-sync-dashboard/issues/230) | specified |
