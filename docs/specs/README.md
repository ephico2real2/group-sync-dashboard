...
| C4 | [`SPEC_C4_idle_timeout.md`](SPEC_C4_idle_timeout.md) — idle timeout with countdown | C — product | R5 | app 0.16.0, chart 0.18.0 | [#65](https://github.com/ephico2real2/group-sync-dashboard/issues/65) | in progress |
| D1 | [`SPEC_D1_audit_log_login_capture.md`](SPEC_D1_audit_log_login_capture.md) — login capture from the oauth-server audit log | D — architecture | R5 | app 0.17.0, chart 0.19.0 | [#66](https://github.com/ephico2real2/group-sync-dashboard/issues/66) | in progress |
