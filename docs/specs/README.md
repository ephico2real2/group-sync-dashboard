...
| S3 | [`SPEC_S3_connection_modes.md`](SPEC_S3_connection_modes.md) — connection modes: the dashboard obtains a remote cluster's credential (SATokenLookup, userSelfLogin) | S — cluster configuration | — | chart 0.45.0 | [#230](https://github.com/ephico2real2/group-sync-dashboard/issues/230) | in progress |
