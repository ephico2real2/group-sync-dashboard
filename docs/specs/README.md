...
| L1 | [`SPEC_L1_remove_oauth_debug.md`](SPEC_L1_remove_oauth_debug.md) — Remove the OAuth Debug reader and authLogLevel Jobs; retain stored history and audit capture | L — login capture | — | app 0.36.0, chart 0.58.0 | [#321](https://github.com/ephico2real2/group-sync-dashboard/issues/321) | merged |
