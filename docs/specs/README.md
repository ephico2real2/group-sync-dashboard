...
| E1 | [`SPEC_E1_report_library.md`](SPEC_E1_report_library.md) — the report library tab: one section per configured report, a run's expiry from the service | E — after the programme | — | app 0.25.0 | [#229](https://github.com/ephico2real2/group-sync-dashboard/issues/229) | released |
| S1 | [`SPEC_S1_cluster_secrets.md`](SPEC_S1_cluster_secrets.md) — clusters as labelled Secrets: the contract, the reader, the API | S — cluster configuration | — | chart 0.42.0, migration 19 | [#230](https://github.com/ephico2real2/group-sync-dashboard/issues/230) | released |
| S2 | [`SPEC_S2_cluster_configurations_tab.md`](SPEC_S2_cluster_configurations_tab.md) — the Cluster Configurations tab: the writes, the form and its GitOps twin | S — cluster configuration | — | chart 0.44.0 | [#230](https://github.com/ephico2real2/group-sync-dashboard/issues/230) | released |
...
| S4a | [`SPEC_S4a_fleet_login_session.md`](SPEC_S4a_fleet_login_session.md) — S4 step A: the fleet login session — obtain, expire, retry, revoke; the code of #283 | S — cluster configuration | — | no version change (a module nothing calls yet; the release that first calls it bumps) | [#283](https://github.com/ephico2real2/group-sync-dashboard/issues/283) | released |
| S4b | [`SPEC_S4b_sa_token_lookup.md`](SPEC_S4b_sa_token_lookup.md) — S4 step B: the ServiceAccount token lookup — read as the fleet account, write as the dashboard; the code of #284 | S — cluster configuration | — | app 0.31.0, chart 0.50.0 | [#284](https://github.com/ephico2real2/group-sync-dashboard/issues/284) | released |
