...
| U1 | [`SPEC_U1_unmanaged_subjects.md`](SPEC_U1_unmanaged_subjects.md) — the unmanaged finding on ServiceAccount and User subjects, silenced only by the operator's `rbac.ocp.io/config-source` label or the exception annotation on the binding; schema migration 20 | U — unmanaged-grant discovery | — | app 0.33.0, chart 0.54.0 | [#353](https://github.com/ephico2real2/group-sync-dashboard/issues/353) | in progress |
