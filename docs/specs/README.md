...
| S2 | [`SPEC_S2_cluster_configurations_tab.md`](SPEC_S2_cluster_configurations_tab.md) — the Cluster Configurations tab: the writes, the form and its GitOps twin | S — cluster configuration | — | chart 0.43.0 | [#230](https://github.com/ephico2real2/group-sync-dashboard/issues/230) | in implementation |
