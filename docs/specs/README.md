...
| B1 | [`SPEC_B1_offsite_backup.md`](SPEC_B1_offsite_backup.md) — off-volume backup CronJob and restore runbook | B — operations | R4 | chart 0.17.0 (chart only) | [#64](https://github.com/ephico2real2/group-sync-dashboard/issues/64) | in progress |
