...
| [`kyverno-discovery-2026-09-20.md`](kyverno-discovery-2026-09-20.md) | What the running Kyverno v1.19.1 on CRC actually serves — the report groups, the `source` field that tells the CEL family from the legacy one, `rule` empty for CEL, finding 10's answer (no VAP for an authorizer-using policy; reports once), the breaker families — #170 step 0 |
