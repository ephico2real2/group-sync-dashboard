...
KEPT_OFF = {
    ...
    "rbacAuditors.enabled": "opt-in cluster-scoped RBAC granted to operator-selected groups; off so an install that does not ask for auditors renders no Group, Role or Binding",
}
