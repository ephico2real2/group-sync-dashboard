...
def test_reporting_tail_rechecks_leadership_after_the_poll():
    ...
    poller._rollup_kpi = Mock(); poller.system_monitor = None       # the KPI steps of the tail (#156)
    poller._discover_console = Mock()                                 # the console discovery (#157)
    ...
    poller._rollup_kpi.assert_called_once()
