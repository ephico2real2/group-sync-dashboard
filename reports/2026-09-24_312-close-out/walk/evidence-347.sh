...
SHOTS=/private/tmp/claude-501/-Users-olasumbo-gitRepos-group-sync-dashboard/77d32da9-736f-4cfc-b61c-10c627692308/scratchpad/ob1/walk312/shots
...
BASE=$(oc logs -n "$NS" "$(pod)" -c dashboard | grep -o "refreshed [0-9]* group bindings for dashboard" | tail -1 | grep -o "[0-9]*"); echo "== baseline (last refresh: $BASE group bindings)"
